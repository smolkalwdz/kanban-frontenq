...
test('enables mixed packages for all Polevaya and MSK zones', () => {
  ...
  expect(isMixedPackageZone('МСК', 1)).toBe(true);
  expect(isMixedPackageZone('МСК', 20)).toBe(true);
  expect(isMixedPackageZone('МСК', 22)).toBe(true);
});
